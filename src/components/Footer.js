      ...
      <div className="flex">
        {Logo ? (
          <div className="brand-cont">
            ...
            {Logo && (
              <Link to="/">
                <img  className="footer_logo" src={Logo} alt={`${footerData.title} logo`} />
              </Link>
            )}
            <address>
        ...
        {mainMenuItems || socialMenuItems || footerMenuItems ? (
          <div className="menus-cont">
            ...
            {footerMenuItems && (
              <ul className="footer-menu">
                {data.allStrapiFooterLinks.nodes[0].footer_page_links.map((item, index) => (
